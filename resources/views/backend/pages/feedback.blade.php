...
@section('admin-section')
    @push('page-title')
        <h1 class="page-title">Feedback Page Settings</h1>
    @endpush
        ...
        <div class="col-lg-6 col-xl-9">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Update Feedback Page Settings</h3>
                </div>
                <div class="card-body">
                    ...
                    @if ($errors->any())
                        ...
                        @endphp
                    @endif
                    <form action="{{ route('page.feedback') }}" method="POST" enctype="multipart/form-data">
                        @csrf

                        <div class="row">
                            <div class="col-sm-6 col-md-6">
                                <div class="form-group">
                                    <label class="form-label">Feedback Hero Background Image </label>
