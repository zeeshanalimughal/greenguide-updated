             ...
             <div class="app-sidebar" style="overflow-y: auto !important">
                 <div class="side-header">
                     <a class="header-brand1" href="/admins">
                         <img src="{{ asset('front/img/green-guide-logo.png') }}"
                             style="min-width: 50px; max-width: 120px; width: 100%;" class="header-brand-img"
                             alt="logo">
                     ...
                     <ul class="side-menu" style="overflow-y: auto !important">
                         ...
                         <li class="slide">
                             <a class="side-menu__item" data-bs-toggle="slide" href="/admins/events"><i
                                     class="side-menu__icon mdi mdi-wunderlist"></i><span class="side-menu__label">Local
                                     Events</span></a>
                         </li>
                         <li class="slide">
                         ...
                         <li class="slide">
                             <a class="side-menu__item" data-bs-toggle="slide" href="/admins/reviews"><i
                                     class="side-menu__icon ion-compose"></i><span class="side-menu__label">Business
                                     Directory Reviews</span></a>
                         </li>
                         <li class="slide">
                             <a class="side-menu__item" data-bs-toggle="slide" href="/admins/replys"><i
                                     class="side-menu__icon ion-compose"></i><span class="side-menu__label">Business
                                     Directory Replys</span></a>
                         </li>
                         <li class="slide">
                             <a class="side-menu__item" data-bs-toggle="slide" href="/admins/magazine-design"><i
                                     class="side-menu__icon icon icon-list"></i><span class="side-menu__label">Magazine
                                     Design Booking</span></a>
                         </li>
                         <li class="slide">
                         ...
                         <li class="slide">
                             <a class="side-menu__item" data-bs-toggle="slide" href="/admins/users"><i
                                     class="side-menu__icon mdi mdi-account-outline"></i><span
