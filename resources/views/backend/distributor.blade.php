...
@section('admin-section')
    @push('page-title')
        <h1 class="page-title">Green Guide Distributors</h1>
    @endpush
                                ...
                                @foreach ($distributors as $distributor)
                                    <tr>
                                        ...
                                        <td><span class="avatar avatar-xl bradius bradius cover-image"
                                                data-bs-image-src="{{ asset('uploads/') }}/{{ $distributor->image }}"
                                                style="background: url(&quot;{{ asset('uploads/') }}/{{ $distributor->image }}&quot;) center center;"></span>
                                        </td>
                                        <td>{{ $distributor->name }}</td>


                                        <td style="word-break: break-word">{{ $distributor->email }}</td>
                                        <td style="word-break: break-word">{{ $distributor->position }}</td>
                                        <td>
                                            @php
        ...
        <div class="modal-dialog modal-lg " role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('distributors.add') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <input type="submit" value="Save Distributor" class="btn btn-primary">
