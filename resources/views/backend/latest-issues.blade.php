...
@section('admin-section')
    @push('page-title')
        <h1 class="page-title">Latest Issues</h1>
    @endpush
...
{{-- 
        <div class="card-body">
            <h3 class="card-title">Latest Issues Headings</h3>
        ...
        <div class="modal-dialog modal-md " role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add New Latest Issue</h5>
                    <button class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('latestIssue.add') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <input type="submit" value="Add Latest Issue" class="btn btn-primary">
