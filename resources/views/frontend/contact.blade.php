...
@section('main-section')
    ...
    <section>
        <div class="container-fluid px-3 px-sm-10">
            <div class="row">
                <div class="col-lg-6">
                        ...
                        <form action="{{ route('contact.send') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="email" name="email" {{ old('email') }} aria-required="true" required=""
                    ...
                    <div class="social-icons m-t-30 social-icons-colored">
                        <ul>
                            <li class="social-facebook" data-animate="fadeInUp" data-animate-delay="800"><a href="#"><i
                            ...
                            <li class="social-pinterest" data-animate="fadeInUp" data-animate-delay="1100"><a href="#"><i
                                        class="fab fa-pinterest"></i></a></li>
                            <li class="social-vimeo" data-animate="fadeInUp" data-animate-delay="1200"><a href="#"><i
                                        class="fab fa-vimeo"></i></a></li>
                            <li class="social-linkedin" data-animate="fadeInUp" data-animate-delay="1300"><a href="#"><i
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <address>
                                ...
                                <a href="mailto:finance@gmail.com">example@example.com</a>  <br>
                                <label title="Phone">P: (123) 456-7890
                            </label></address>
                        </div>
                        <div class="col-lg-6">
                             <address>
                                ...
                                <a href="mailto:Design@gmail.com">example@example.com</a>  <br>
                                <label title="Phone">P: (123) 456-7890
                            </label></address>
                        </div>
                    </div>
                   ...
                   <div class="col-12 mt-4">
                      <div class="opt_section bg-primary">
                          ...
                          <div class="row ps-5 p-4 pt-0 text-white">
                            ...
                            <p>Notify us of your complaint and out professional customer service team will be in touch to try and resolve the metter. Fill out our <u>make a complaint</u> form</p>
                          </div>
                      </div>
                   </div>
                </div>
            ...
            <div class="row mt-5">
                <div class="col-12">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2477.241881356656!2d-0.050808684338578!3d51.61877817965347!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48761e8ae036c7b1%3A0x85f7847126c3629f!2sLocal%20Green%20Guide%20Ltd%20-%20LGG%20Marketing!5e0!3m2!1sen!2s!4v1639087067763!5m2!1sen!2s" style="border:0;widows: 100% !important; height: 50vh !important;" allowfullscreen="" loading="lazy"></iframe>
