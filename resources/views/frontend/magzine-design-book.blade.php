        ...
        <div class="container">
            ...
            <form method="POST" class="form-validate" action="{{ route('design.submit-design') }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-5">
                        <select class="form-select" name="upcomingIssue" required="required">
                            ...
                            @foreach ($issues as $issue)
                                <option value="{{ $issue->id }}">{{ $issue->issue }} - {{ $issue->deadline }}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-5">
                        <input class="form-control" type="text" name="ins" required="" />
                        @if ($errors->has('ins'))
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-5">
                        <input class="form-control" type="text" name="yt" required="" />
                        @if ($errors->has('yt'))
