...
<head>
    ...
    <title>London Borough of Bromley</title>
    <style>
...
<body>
    ...
    <div class="comming__soon__page__wrapper">
        ...
        <h1 class="main__title">
            London Borough of Bromley is <br>Coming Soon
        </h1>
        ...
        <p class="description">
            ...
            <br>
            Don't miss out on the opportunity to be apart of the Local Green Guide London Borough of Bromley magazine.
            To
        ...
        <form action="{{ route('commingsoon.london-borough') }}" method="POST" class="form">
            ...
            @endif
            <input type="hidden" name="area_name" value="London Borough of Bromley ">
