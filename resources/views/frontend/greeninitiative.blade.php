        ...
        <div class="container d-flex justify-content-center">
            <div class="row">
                <div class="col-lg-6 col-md-12 ">
                    <h3 class="mb-2 p-0 text-center">{{$page[0]->gi_greenguide_box_heading}}</h3>

                    <div class="green__guide__box bg-dark text-white">
                        @php
                            echo $page[0]->gi_greenguide_box_content;
                        @endphp


                        {{-- <div class="logo"><img style="width:120px" src="{{ asset('front/img/green-guide-logo.png') }}"
                                alt=""></div>
                        <h2>Green Guide</h2>
                        <div class="row mb-4">
                            <div class="col-12 d-flex align-items-center">
                                <img style="width:70px; margin-right: 12px; object-fit: cover;"
                                    src="{{ asset('front/img/edenproject-150x150.png') }}" alt="">
                                <h2 class="p-0 m-0" style="line-height: 20px">100 |<span style="font-size:16px;"> Trees
                                        Planted</span></h2>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-12 d-flex align-items-center">
                                <img style="width:70px; margin-right: 12px; object-fit: cover;"
                                    src="{{ asset('front/img/edenproject-150x150.png') }}" alt="">
                                <h2 class="p-0 m-0" style="line-height: 20px">3.75 |<span style="font-size:16px;"> Tons of
                                        CO2 absorbed yearly</span></h2>
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-12 d-flex align-items-center">
                                <img style="width:70px; margin-right: 12px; object-fit: cover;"
                                    src="{{ asset('front/img/edenproject-150x150.png') }}" alt="">
                                <h2 class="p-0 m-0" style="line-height: 20px">15.00 |<span style="font-size:16px;"> Tons of
                                        Oxygen created yearly</span></h2>
                            </div>
                        </div> --}}
                        <div class="row mb-4">
                            <div class="col-12 d-flex align-items-center">
                ...
                <div class="col-lg-6 col-md-12 ">
                    <h3 class="mb-2 p-0 text-center">{{$page[0]->gi_greenguide_forest_box_heading}}</h3>
                    <div class="green__guide__box bg-dark text-white">
                        @php
                        echo $page[0]->gi_greenguide_forest_box_content;
                    @endphp
                        ...
                        <div class="row mb-4">
                            <div class="col-12 d-flex align-items-center">
                                <img style="width:70px; margin-right: 12px; object-fit: cover;"
                                    src="{{ asset('front/img/edenproject-150x150.png') }}" alt="">
                                <h2 class="p-0 m-0" style="line-height: 20px">15.00 |<span style="font-size:16px;"> Tons
                                        of Oxygen created yearly</span></h2>
                            </div>
                        </div> --}}
                        <div class="row mb-4">
                            <div class="col-12 d-flex align-items-center">
    ...
    <section class="resycling my-4 bg-white py-5">
        <div class="container">
            <div class="row d-flex justify-content-between">
                ...
                <div class="col-lg-7 col-md-12 col-sm-12 mt-3 mt-sm-0" data-animate="fadeInRight"
        ...
        <div class="container">
            <div class="row d-flex justify-content-between">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 mt-3 mt-sm-0">
                    <h1 class=" line-height-l font-weight-600 text-left" data-animate="fadeInUp"
                        data-animate-delay="800">
                        {{ $page[0]->gi_sec4_title }}</h1>
                    <div class="text-dark font-size-lg line-height-l text-justify" align="justify"
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 mt-5" data-animate="fadeInRight" data-animate-delay="1200">
                    <div class="img-container position-relative w-100 bg-primary">
                        <img src="{{ url('uploads/' . $page[0]->gi_sec4_image) }}" class="img-responsive w-100"
                            alt="">
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row d-flex justify-content-between">
                <div class="col-lg-6 col-md-12 col-sm-12 mt-5" data-animate="fadeInLeft" data-animate-delay="500">
                    <div class="img-container position-relative w-100 bg-primary">
                        <img src="{{ url('uploads/' . $page[0]->gi_sec6_image) }}" class="img-responsive w-100"
                            alt="">
