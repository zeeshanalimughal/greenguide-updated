...
@section('main-section')
    <section id="page-title" class="text-light" data-bg-parallax="http://localhost/greenguide/uploads/images/pages_1_35_5.jpg">
    ...
    <section>
        <div class="container">
            ...
            @if ($form[0]->status === 'live')
                <form method="POST" class="form-validate" action="{{ route('events.add-event') }}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <textarea class="form-control" type="text" name="event_description" style="visibility: hidden; display: none;"></textarea>
            ...
            @else
                <h2>Add Event Form Is Not Available</h2>
            @endif
        </div>
    </section>
@endsection
